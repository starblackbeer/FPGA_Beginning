...
vlog -vlog01compat -work work +incdir+E:/FPGA_Code/AC620_Draft/class4_beep/rtl {E:/FPGA_Code/AC620_Draft/class4_beep/rtl/beep_test.v}

vlog -vlog01compat -work work +incdir+E:/FPGA_Code/AC620_Draft/class4_beep/prj/../testbench {E:/FPGA_Code/AC620_Draft/class4_beep/prj/../testbench/beep_test_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  beep_test_tb
